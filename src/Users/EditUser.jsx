...
class EditUser extends Component {
  ...
  componentDidMount() {
    axios.get('http://localhost:5000/users/edit-user/' + this.props.match.params.id)
      .then(res => {
        this.setState({
          name: res.data.name,
  ...
  handleSubmit = (e) => {
    ...
    if (formValid(this.state)&&this.validateCheckBox) {
      ...
      axios.put('http://localhost:5000/users/update-user/' + this.props.match.params.id, userObject)
      .then((res) => {
